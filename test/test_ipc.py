...
class TestRedis(unittest.TestCase):
    def test_msg_cast1(self):
        TestMessage = namedtuple('PrintMessage',
                                 'barcode, origin, redis, name')
        msg = TestMessage(barcode="1234",
    ...
    def test_msg_serialize1(self):
        i = IpcPrintMessage(barcode="barcode",
                            name="name",
                            origin=IpcOrigin.TEST,
                            number=1,
                            device=None)
